...
from sft.train_v4 import _load_model_and_tokenizer


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Load-check a Phase 3-v4 LoRA checkpoint.")
...
def verify(config_path: str, checkpoint_override: str | None) -> dict[str, object]:
    ...
    report = {
        ...
        "v1_v2_v3_artifacts_touched": False,
    }
