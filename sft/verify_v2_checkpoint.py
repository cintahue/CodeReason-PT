...
from sft.train_v2 import _load_model_and_tokenizer


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Load-check a Phase 3-v2 LoRA checkpoint.")
    parser.add_argument("--config", default="configs/sft_v2.yaml")
    parser.add_argument("--checkpoint", default=None)
    return parser.parse_args()


def verify(config_path: str, checkpoint_override: str | None) -> dict[str, Any]:
